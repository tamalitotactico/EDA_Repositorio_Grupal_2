      ...
      <table class="c45">
         ...
         <tr class="c20">
            <td class="c39" colspan="4" rowspan="1">
               ...
               <ul class="c5 lst-kix_ebg3f8hr7p5y-0 start">
      ...
      <table class="c45">
         ...
         <tr class="c69">
            <td class="c36" colspan="1" rowspan="1">
               ...
               <img alt="" src="https://github.com/tamalitotactico/EDA_Repositorio_Grupal_2/blob/main/commits/image1.png?raw=true" style="width: 328.19px; height: 112.82px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title="">
               ...
               <p class="c16"><span class="c7"></span></p>
               <p class="c16"><span class="c7"></span></p>
               <p class="c23"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 220.50px; height: 228.98px;"><img alt="" src="https://github.com/tamalitotactico/EDA_Repositorio_Grupal_2/blob/main/commits/image3.png?raw=true" style="width: 220.50px; height: 228.98px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p>
               <p class="c22 c35"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 351.00px; height: 227.06px;"><img alt="" src="https://github.com/tamalitotactico/EDA_Repositorio_Grupal_2/blob/main/commits/image2.png?raw=true" style="width: 351.00px; height: 499.19px; margin-left: 0.00px; margin-top: -272.13px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 287.00px; height: 235.00px;"><img alt="" src="https://github.com/tamalitotactico/EDA_Repositorio_Grupal_2/blob/main/commits/image2.png?raw=true" style="width: 300.00px; height: 427.65px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p>
               ...
               <p class="c9"><span class="c7"></span></p>
               <p class="c22 c35"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 456.02px; height: 292.14px;"><img alt="" src="https://github.com/tamalitotactico/EDA_Repositorio_Grupal_2/blob/main/commits/image1.png?raw=true" style="width: 456.02px; height: 292.14px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p>
               <p class="c18 c40"><span class="c7"></span></p>
         ...
         <tr class="c17">
            <td class="c36" colspan="1" rowspan="1">
               ...
               <ul class="c5 lst-kix_e6stc6xhflmd-0">
                  <li class="c18 c41 li-bullet-0"><span class="c33">&iquest;Qu&eacute; beneficios y oportunidades ofrecen las clases gen&eacute;ricas en Java?</span></li>
               </ul>
         ...
         <tr class="c65">
            <td class="c36" colspan="1" rowspan="1">
               <ul class="c5 lst-kix_f1d3m4ami629-0 start">
                  ...
                  <li class="c22 c28 li-bullet-0"><span class="c19"><a class="c27" href="https://www.google.com/url?q=https://docs.oracle.com/javase/tutorial/java/generics/types.html&amp;sa=D&amp;source=editors&amp;ust=1652764725458532&amp;usg=AOvVaw21u4vJFE4IrxvRqz4hQMZy">https://docs.oracle.com/javase/tutorial/java/generics/types.html</a></span></li>
